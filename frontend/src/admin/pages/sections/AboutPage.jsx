  ...
  return (
    <div className="space-y-6 pb-24">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">The About Me section heading, paragraph and trait chips.</p>
      </div>
      ...
      <div className="grid gap-6 rounded-2xl border border-navy-700 bg-navy-800/50 p-6">
        ...
        <div>
          <label className="mb-1.5 block text-sm font-medium text-slate-300">Paragraph</label>
          <textarea
            rows={4}
        ...
        <div>
          <div className="mb-2 text-sm font-medium text-slate-300">Traits</div>
          <ItemListEditor items={draft.traits || []} onChange={(next) => setField("traits", next)} itemLabel="line" />
        </div>
      </div>
